...
Future<void> deleteUserInfoAPI(int account) async {
  await dioRequest.delete(HttpConstants.MANAGER_USER_DELETE, params: {"account": account});
...
Future<void> updateUserInfoAPI(Map<String, dynamic> userInfo) async {
  await dioRequest.post(HttpConstants.MANAGER_USER_UPDATE, data: userInfo);
}
